...
app.post('/menuUpdate_process', function(request, response){
    var post = request.body;
    // var name = request.params.name;
    sql.menu_update(request, response, post);
})

app.post('/menuDelete_process', function(request, response){
    var post = request.body;
    sql.menu_delete(request, response, post);
})
